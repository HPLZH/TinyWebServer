...
{
	return responseNoContent(mem, HTTP_400, HEADER_NO_CONTENT);
}
...
{
	return responseNoContent(mem, HTTP_403, HEADER_NO_CONTENT);
}
...
{
	return responseNoContent(mem, HTTP_404, HEADER_NO_CONTENT);
}
...
{
	return responseNoContent(mem, HTTP_405, HEADER_405);
}
...
{
	return responseNoContent(mem, HTTP_500, HEADER_NO_CONTENT);
}
